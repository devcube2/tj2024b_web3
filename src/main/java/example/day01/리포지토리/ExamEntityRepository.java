...
// 엔티티(테이블) 조작(DML) 하는 인터페이스
// 해당 인터페이스에 JpaRepository <조작할 엔티티 클래스명, 해당 엔티티의 ID타입> 상속
// < > : 제네릭
@Repository
...
//      반환값 : INSERT/UPDATE 이후 영속(연결/배핑)된 객체(엔티티)
...
// 2. .get() : 객체 반환
// 3. .orElse(null일때 값) : 객체 반환하는데 null 이면 지정된 값 반환
